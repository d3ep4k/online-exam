...
public class StretchIcon extends ImageIcon {
     ...
     *
     * @param imageData an array of pixels in an image format supported by the
     * AWT Toolkit, such as GIF, JPEG, or (as of 1.3) PNG
     *
     ...
     * @param imageData an array of pixels in an image format supported by the
     * AWT Toolkit, such as GIF, JPEG, or (as of 1.3) PNG
     * @param proportionate <code>true</code> to retain the image's aspect
     * ratio, <code>false</code> to allow distortion of the image to fill the
     * component.
     *
     * @see ImageIcon#ImageIcon(byte[])
     */
    ...
    /**
     * Creates a <CODE>StretchIcon</CODE> from the specified file with the
     * specified behavior.
     *
     * @param filename a String specifying a filename or path
     * @param proportionate <code>true</code> to retain the image's aspect
    ...
    /**
     * Creates a <CODE>StretchIcon</CODE> from the specified URL with the
     * specified behavior.
     *
     * @param location the URL for the image
     * @param proportionate <code>true</code> to retain the image's aspect
